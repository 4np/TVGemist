//
//  PlayerViewController+FairPlay.swift
//  TVGemist
//
...
extension PlayerViewController: AVAssetResourceLoaderDelegate {
    ...
    func resourceLoader(_ resourceLoader: AVAssetResourceLoader, shouldWaitForLoadingOfRequestedResource loadingRequest: AVAssetResourceLoadingRequest) -> Bool {
        ...
        guard let fairPlayStream = fairPlayStream else {
        ...
        guard let certificateURL = fairPlayStream.certificateURL, let certificateData = try? Data(contentsOf: certificateURL) else {
        ...
        var request = URLRequest(url: fairPlayStream.licenseServer)
